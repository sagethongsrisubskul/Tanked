...
public class tankentity extends Entity {
	...
	public tankentity(final float x, final float y,final char team){
		...
		switch(team){
			case 'r': addImageWithBoundingBox(ResourceManager.getImage(Filenames.tank_r).getScaledCopy(0.05f));
			break;
			
			case 'g': addImageWithBoundingBox(ResourceManager.getImage(Filenames.tank_g).getScaledCopy(0.05f));
			break;
			
			case 'b': addImageWithBoundingBox(ResourceManager.getImage(Filenames.tank_b).getScaledCopy(0.05f));
			break;
			
			case 'y': addImageWithBoundingBox(ResourceManager.getImage(Filenames.tank_y).getScaledCopy(0.05f));
			break;
		}
