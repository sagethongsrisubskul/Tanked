...
public class DisplaysStateHelpControls
	{
	...
	public static void positionDisplays()
		...
		DisplaysHeading.positionHeading(Strings.helpInfo + " : " + Strings.gameControls);
	...
	public static void formatHelpText()
		{
		helpText = Strings.formatString(Strings.gameControlsText, textWidth, textHeight);
